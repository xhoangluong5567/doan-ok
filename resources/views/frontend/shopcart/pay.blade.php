                            ...
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive"
                                        src="{{ url('upload') }}/{{ $product->options->images }}" />
                                </div>
                                ...
                                <div class="col-sm-3 col-xs-3 text-right">
                                    ...
                                    <h6><span>Tổng
                                            Giá:<br></span>{{ number_format($product->price * $product->qty) }}VND
                                    </h6>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <div class="pull-right" style="color:red; font-weight: bold;">
                                    <span>{{ Cart::subtotal() }} VND </span></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="address" class="form-control"
                                    value="{{ get_data_user('web','address') }}" />
                            </div>
                        </div>
                        <div class="form-group">
